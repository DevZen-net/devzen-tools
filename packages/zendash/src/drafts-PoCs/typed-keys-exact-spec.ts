   ...
   */
    ...
    function fn(k: keyof Point) {
      if (k === 'x') {
        ...
        // throw new Error('This is impossible') // ZenDash: This should never happen! Why bother with extra keys? It is absolutely possible, and fine to pass sub-instances to our functions, as long as we dont moan about extra stuff they might have. It's a principle in OO programming, to be able to pass sub-instances to functions that expect the parent type, without loosing typing!
      }
    }
