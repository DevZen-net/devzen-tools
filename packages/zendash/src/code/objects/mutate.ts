 ...
 *
 * const arr = [11, 2, -1]
 * _z.mutate(arr, simpleCalc, (v) => v > 10) // with _z.isAgree agreement as filter
 *
 ...
 *
 * @param agreement an agreement filter as in [`_z.isAgree`](/functions/isAgree.html). If it is true, value is mutated, otherwise it's left intact. Note: isAgree allows "undefined" as a truthy filter value.
 *
