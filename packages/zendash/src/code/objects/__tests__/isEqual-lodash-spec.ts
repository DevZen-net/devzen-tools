...
// - Tests run in both 'ZenDash _z.isEqual' : 'Lodash _.isEqual'
...
_.each([_.isEqual, _z.isEqual], (isEqual) => {
  const isZisEqual = isEqual === _z.isEqual

  describe(`Lodash'es isEqual tests, both against Lodash & ZenDash: ${
    ...
    describe('should compare primitives', () => {
      const pairs = [
        [1, 1, true],
        [1, Object(1), true, false], // ### _z.isEqual DIFFERENT @todo: implement options.unbox or similar for this case
        [1, '1', false],
        [1, 2, false],
        [-0, -0, true],
        [0, 0, true],
        [0, Object(0), true, false], // ### _z.isEqual DIFFERENT @todo(151): implement options.unbox or similar for these weird cases
        [Object(0), Object(0), true],
        [-0, 0, true],
        [0, '0', false],
        [0, null, false],
        [NaN, NaN, true],
        [NaN, Object(NaN), true, false], // ### _z.isEqual DIFFERENT @todo(151): implement options.unbox or similar for these weird cases
        [Object(NaN), Object(NaN), true],
        [NaN, 'a', false],
        [NaN, Infinity, false],
        ['a', 'a', true],
        ['a', Object('a'), true, false], // ### _z.isEqual DIFFERENT @todo(151): implement options.unbox or similar for these weird cases
        [Object('a'), Object('a'), true],
        ['a', 'b', false],
        ['a', ['a'], false],
        [true, true, true],
        [true, Object(true), true, false], // ### _z.isEqual DIFFERENT @todo(151): implement options.unbox or similar for these weird cases
        [Object(true), Object(true), true],
        [true, 1, false],
        [true, 'a', false],
        [false, false, true],
        [false, Object(false), true, false], // ### _z.isEqual DIFFERENT @todo(151): implement options.unbox or similar for these weird cases
      ...
      _.each(pairs, ([a, b, expected, zenDashExpectedIfDifferent]) =>
        it(`a: ${toStringSafe(a)}, b: ${toStringSafe(b)} => ${expected} ${zenDashExpectedIfDifferent === undefined ? '' : '### _z.isEqual DIFFERENT: ' + zenDashExpectedIfDifferent}`, () => {
          expected =
            isZisEqual && zenDashExpectedIfDifferent !== undefined
              ? zenDashExpectedIfDifferent
              : expected
          expect(isEqual(a, b)).to.equal(expected)
        })
      )

      it(`Symbol & Object(Symbol) => true ### _z.isEqual DIFFERENT: false`, () => {
    ...
    describe('should compare arrays', () => {
      ...
      // ### _z.isEqual DIFFERENT
      it('should equal with sparse arrays & ones with undefined in its place ### _z.isEqual DIFFERENT (false): will work in future with `options.sparse` or something', () => {
        array1 = [1]
        array1[2] = 3
      ...
      // ### _z.isEqual DIFFERENT
      it('should compare Object wrapped values: ### _z.isEqual DIFFERENT (false): will change in future with `options.valueOf`', () => {
        array1 = [
          Object(1),
          false,
          Object('a'),
      ...
      it('should compare sparse arrays ### _z.isEqual DIFFERENT sparse arrays are strict & respected for their actual indexes', () => {
        const array = Array(1)
    ...
    ;(isZisEqual ? it.skip : it)(
      'should compare nested objects - ### _z.isEqual DIFFERENT fails cause of Object() wrapped objects',
      () => {
        const object1 = {
          a: [1, 2, 3],
          b: true,
    ...
    describe('circular references', () => {
      ...
      it('should compare objects with circular references', () => {
        ...
        object1.b = 0
        // lodash tests for ZenDash: changed from
        //        object2.b = Object(0)
    ...
    if (typeof Map === undefined) describe('Map NOT supported - skipped tests', () => {})
      ...
      it('should compare Maps with circular references', () => {
        // ZenDash: added some nested values
    ...
    if (typeof Symbol === undefined) describe('Symbol NOT supported - skipped tests', () => {})
      ...
      describe('should compare symbol properties ### _z.isEqual DIFFERENT', () => {
        let object1 = {}
        let object2 = {}
        ...
        it('should fail if symbol properties are different: ### _z.isEqual DIFFERENT - returns true, cause `options.symbol: false`', () => {
          object2[symbol1] = { a: 1 }
        ...
        if (isZisEqual)
          it('### _z.isEqual DIFFERENT should fail if symbol properties are different: only with `options.symbol: true`', () => {
            object2[symbol1] = { a: 1 }
            expect(isEqual(object1, object2, { symbol: true })).to.be.false
          })

        it('should fail if extra symbol properties: ### _z.isEqual DIFFERENT - returns true, cause `options.symbol: false`', () => {
