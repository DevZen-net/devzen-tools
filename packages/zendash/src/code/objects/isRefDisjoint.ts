...
/**
 * Default options for [`_z.isRefDisjoint`](/functions/isRefDisjoint.html)
 */
...
/**
 * Options interface for [`_z.isRefDisjoint`](/functions/isRefDisjoint.html)
 */
...
/**
 *  Given two Property Bags (i.e any _z.isRef, incl Objects, Arrays, Set, Maps, Symbols, Boxed primitives etc), it returns `true` if there are **NO common/shared References** in their entries/elements/properties.
 *
