...
export const loop_each_map_clone_filter_take_SpecHandler = (
  ...
  describe(`SUITE: _z.${testFunction}(): ${testDescr}:`, () => {
    _.each(
      <[string, ILoopOptions<any, any, any>, any, any, [number | string | symbol, any][]][]>[
        ...
        ..._.map(['all', false], (props) => [
          ...
          // expectedClone
          new Error(
            `_z.clone(): Could not clone the given value: _z.map(): options.map can NOT be used here - use mapCb only`
          ),
          ...
          // expectedMap
          new Error(`_z.map(): options.map can NOT be used here - use mapCb only`),
        ...
        ..._.map(['all', false], (props) => [
          ...
          // expectedFiltered
          new Error(`_z.filter(): options.filter can NOT be used here - use filterCb only`),
          // expectedTake
        ...
        [
          ...
          // expectedClone - throws
          new Error(
            `_z.clone(): Could not clone the given value: _z.loop(): options.dataViewType is required to loop over an ArrayBuffer`
          ),
        ...
        [
          ...
          new Error(
            `_z.project() as _z.filter(): Can't filter or take with filterSingles: false over an _z.isSingleOrWeak value 123`
          ),
        ...
        [
          ...
          new Error(
            `_z.clone(): Could not clone the given value: _z.map(): WeakMap & WeakSet are not supported!`
          ),
          // expectedLoopOrEach - no iteration
          [],
          // expectedMap - throws - not supported
          new Error(`_z.map(): WeakMap & WeakSet are not supported!`),
          // expectedFiltered - throws - not supported
          new Error(
            `_z.project() as _z.filter(): Can't filter or take with filterSingles: false over an _z.isSingleOrWeak value [object WeakMap]`
          ),
          // expectedTake - throws - not supported
          new Error(
            `_z.project() as _z.take(): Can't filter or take with filterSingles: false over an _z.isSingleOrWeak value [object WeakMap]`
          ),
        ],
        [
          ...
          new Error(`_z.map(): WeakMap & WeakSet are not supported!`),
          // expectedFiltered - throws - not supported
          new Error(`_z.filter(): WeakMap & WeakSet are not supported!`),
          // expectedTake - throws - not supported
          new Error(`_z.take(): WeakMap & WeakSet are not supported!`),
        ],
        [
          ...
          // expectedFiltered - throws - not supported
          new Error(
            `_z.project() as _z.filter(): Can't filter or take with filterSingles: false over an _z.isSingleOrWeak value [object WeakSet]`
          ),
          // expectedTake - throws - not supported
          new Error(
            `_z.project() as _z.take(): Can't filter or take with filterSingles: false over an _z.isSingleOrWeak value [object WeakSet]`
          ),
        ],
        [
        ...
        [
          ...
          // expectedClone - throws
          new Error(
            `_z.clone(): Could not clone the given value: _z.loop(): strict = true, but wrong _z.isMany type. With type(value) === 'number' & value = 123`
          ),
          // expectedLoopOrEach - throws
          new Error(
          ...
          // expectedTake - throws
          new Error(
            `_z.project() as _z.take(): Can't filter or take with filterSingles: false over an _z.isSingleOrWeak value 123`
          ),
        ],
        [
          ...
          // expectedLoopOrEach
          new Error(
            `_z.loop(): strict = true, but wrong _z.isMany type. With type(value) === 'WeakSet' & value = [object WeakSet]`
          ),
          // expectedMap
          new Error(`_z.map(): WeakMap & WeakSet are not supported!`),
          // expectedFiltered
        ...
        [
          ...
          new Error(
            `_z.loop(): strict = true, but wrong _z.isMany type. With type(value) === 'WeakMap' & value = [object WeakMap]`
          ),
          // expectedMap
          new Error(`_z.map(): WeakMap & WeakSet are not supported!`),
          // expectedFiltered
        ...
        [
          ...
          // expectedClone
          new Error(
            `_z.clone(): Could not clone the given value: _z.loop(): strict = true, but wrong _z.isMany type. With type(value) === 'function' & value = (arg1, arg2) => "double quotes" + 'single quotes' + \`backtick quotes\``
          ),
          // expectedLoopOrEach
          new Error(
            `_z.loop(): strict = true, but wrong _z.isMany type. With type(value) === 'function' & value = (arg1, arg2) => "double quotes" + 'single quotes' + \`backtick quotes\``
          ),
          // expectedMap
          new Error(
            `_z.loop(): strict = true, but wrong _z.isMany type. With type(value) === 'function' & value = (arg1, arg2) => "double quotes" + 'single quotes' + \`backtick quotes\``
          ...
          // expectedFiltered
          new Error(
            `_z.project() as _z.filter(): Can't filter or take with filterSingles: false over an _z.isSingleOrWeak value (arg1, arg2) => "double quotes" + 'single quotes' + \`backtick quotes\``
          ),
          // expectedTake
          new Error(
            `_z.project() as _z.take(): Can't filter or take with filterSingles: false over an _z.isSingleOrWeak value (arg1, arg2) => "double quotes" + 'single quotes' + \`backtick quotes\``
          ),
        ],
        ...
        [
          ...
          new TypeError(
            `_z.clone(): Cannot clone an Iterator/Generator or an Async Generator/Iterator, cause they cant be restarted! You can map over the **remaining items** of the iterator by using \`_z.map()\` instead`
          ),
        ...
        [
          ...
          // expectedFilter - we actually test the iteration results below, not the actual return value of _z.filter(), nor props
        ...
        [
          ...
          new TypeError(
            `_z.map(): Cannot map over an Iterator or an AsyncIterator with symbol: true & strict: true`
          ),
          // expectedFilter
          new TypeError(
            `_z.filter(): Cannot filter over an Iterator or an AsyncIterator with symbol: true & strict: true`
          ),
          // expectedTake
          new TypeError(
            `_z.take(): Cannot take over an Iterator or an AsyncIterator with symbol: true & strict: true`
          ),
        ],
          ...
          ;(onlyThisSuite && !testFunctionOnly ? describe.only : describe)(
            ...
            () => {
              ...
              switch (testFunction) {
                ...
                case 'loop': {
                  describe(
                    getSUITEname(testFunction === 'loop' ? `for...of _z.loop()` : `_z.each()`),
                    () => {
                      ...
                      const functionTitle = `\`${cFunction(
                        testFunction === 'loop'
                          ...
                          : `_z.each(val/*: ${c.dim(cType(input))}*/, (val, idxOrKey) => ...)`
                      )}\``
                ...
                case 'take': {
                  describe(getSUITEname(), () => {
                    ...
                    if (_.isError(expected)) {
                      it(`throws: ${cFunction(`_z.${testFunction}`)} matches expected Error`, () => {
                      ...
                      if (isNothing(expected))
                        it(`${cFunction(`_z.${testFunction}`)} result is '${String(NOTHING)}'`, () => {
                          expect(result).to.equal(NOTHING)
                        })
                      else
                        it(`${cFunction(`_z.${testFunction}`)} result is the correct type of '${cType(input)}'`, () => {
                          if (type(result) === type(input))
                            expect(type(result)).to.equal(type(input))
                          else {
                            console.error(
                              c.red(`_z.${testFunction} type(result) !== type(input)`),
                              '\n type(input) =',
                              type(input),
                              '\n type(result)=',
                              type(result)
                      ...
                      if (isGenerator(input) || isPlainIterator(input)) {
                        ...
                        it(`${cFunction(
                          ...
                          if (
                            ...
                            console.error(
                              c.red(`_z.${testFunction} NOT (isEqual(result, expected)`),
                              'expected =',
                              expected,
                              '\n result=',
                              result
                        ...
                        if (_.isObject(input) && !isNothing(expected))
                          it(`${cFunction(`_z.${testFunction}`)} returns a new value / different ref '${cType(input)}'`, () => {
                        ...
                        if (
                          ...
                          it(`${cFunction(`_z.${testFunction}`)} returns '${cType(input)}' with correct size/length`, () => {
