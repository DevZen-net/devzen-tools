...
describe('any (null posing as any)', () => {
  const inputTitle = `null as any` // just for title
  describe(inputTitle, () => {
    const getInputVanilla = () => null as any
    const getInputWithExtraCommonProps = () => null as any
