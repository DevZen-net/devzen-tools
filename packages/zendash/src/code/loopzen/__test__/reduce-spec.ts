...
describe('reduce.spec (based on values.spec) - behavioural/implementation, no types check', () => {
  describe('_z.reduce() - custom tests', () => {
    const array = [1, 2, 3, 10, 20, 30]

    describe(`_z.reduce() - simple array`, () => {
      const input = array
      ...
      describe('_z.reduce() - STOP reducing, include up to 3rd item', () => {
    ...
    describe(`_z.reduce() - AsyncGenerator`, () => {
  ...
  _.each(
    ...
    ([description, options, input, expected]: [
      ...
      describe(`_z.reduce retrieves all items of: "${description}" into an array`, () => {
        let result: any
