...
describe('Many, with Inspectable Nested Values', () => {
  ...
  describe(inputTitle, () => {
    const getInputVanilla = () => a_TypedArray_Int32Array
    const getInputWithExtraCommonProps = () => a_TypedArray_Int32Array_withCommonAndArrayExtraProps
    ...
    const expected_stringNonEnumerablesOwn_values = typedArray_prototype_stringNonEnumerablesOwn.map((value) => a_TypedArray_Int32Array[value])
    ...
    // top values
    type Texpected_stringNonEnumerablesInheritedTop_values = ValueOfStrict<Object, Exclude<keyof Object, keyof Int32Array>>
