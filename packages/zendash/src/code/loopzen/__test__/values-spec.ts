  ...
  _.each(
    <[string, IKeysOptions, any, (string | symbol)[]][]>[
      ...
      [
        ...
        get_arrayBuffer_Uint8(),
        new Error(
          `_z.values(): options.dataViewType is required to loop over an ArrayBuffer to pick its nested values()`
        ),
      ],
      ...
      [
        ...
        undefined,
        new Error(
          `_z.keys: strict: true works only for types passing _.isObject, but value = undefined`
        ),
      ],
      [
        'null',
        ...
        null,
        new Error(
          `_z.keys: strict: true works only for types passing _.isObject, but value = [object Null]`
        ),
      ],
      [
        'number',
        ...
        123,
        new Error(
          `_z.keys: strict: true works only for types passing _.isObject, but value = 123`
        ),
      ],
      [
        'string',
        ...
        'a string',
        new Error(
          `_z.keys: strict: true works only for types passing _.isObject, but value = a string`
        ),
      ],
      [
        'boolean',
        ...
        true,
        new Error(
          `_z.keys: strict: true works only for types passing _.isObject, but value = true`
        ),
      ],
      [
        'bigint',
        ...
        1234n,
        new Error(
          `_z.keys: strict: true works only for types passing _.isObject, but value = 1234`
        ),
      ],
      [
        'symbol',
        ...
        Symbol('someLabel'),
        new Error(
          `_z.keys: strict: true works only for types passing _.isObject, but value = Symbol(someLabel)`
        ),
      ],
    ],
    ([description, options, input, expected]: [
      ...
      describe(`_z.values retrieves all values of: ${description}`, () => {
        let result: any
