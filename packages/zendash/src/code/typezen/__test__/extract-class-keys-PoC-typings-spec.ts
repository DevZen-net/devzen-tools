  ...
  describe(`Simple MyClass`, () => {
    ...
    describe(`Keys of MyClass instance, prototype & class`, () => {
      ...
      describe(`MyClass static props (keyof typeof MyClass)`, () => {
        ...
        it('_.keys / Object.keys / _z.keys give only static props on the class, not its prototype chain. Hence `myStaticMethod` is not returned', () => {
  ...
  describe(`With Symbols & Inheritance`, () => {
    ...
    describe(`Keys of ParentClass instance, prototype & class`, () => {
      ...
      describe(`ParentClass static props (keyof typeof ParentClass)`, () => {
        ...
        it('_.keys / Object.keys / _z.keys give only static props on the class, not its prototype chain. Hence `parentStaticMethod` is not returned', () => {
    ...
    describe(`Keys of ChildClass instance, prototype & class`, () => {
      ...
      describe(`ChildClass static props (keyof typeof ChildClass)`, () => {
        ...
        it('_.keys / Object.keys / _z.keys give only static props on the class, not its prototype chain. Hence `childStaticMethod` is not returned', () => {
