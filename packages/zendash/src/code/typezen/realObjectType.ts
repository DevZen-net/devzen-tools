...
/**
 * Determine the type of an [`_z.isRealObject`](/functions/isRealObject.html): an `'instance'` of a class or a plain `'pojso'` object.
 *
 * If it is not an [`_z.isRealObject`](/functions/isRealObject.html), it returns `undefined`, which means you need to [`_z.type()`](/functions/type.html) it to get the proper type.
 *
