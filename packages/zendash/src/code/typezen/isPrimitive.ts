 ...
 * Boxed Primitives
 *
 * Boxed / object versions of primitives result to false in `_z.isPrimitive`, i.e they are NOT considered primitives (they are Boxed Primitives).
 *
 * This is in contrast to [`isSingle`](/functions/isSingle.html) that considers boxed values as `_z.isSingle` and their `_z.type` is their designated type.
 *
 * To check Boxed Primitives, use [`_z.isBoxedPrimitive()`](/functions/isBoxedPrimitive.html) or use the individual `_z.isBoxedXxx` functions.
 *
 * @see [`_z.isSingle()`](/functions/isSingle.html) is a broader version of `isPrimitive`
 *
