 ...
 *
 * - Unlike [`_z.isRealObject()`](/functions/isRealObject.html), it does not return `true` for instances created by `new Xxx` or for `Array` or `Function` or `new String()` etc.
 *
 ...
 *
 * @see [`_z.isInstance()`](/functions/isInstance.html) for the instance-only check
 *
 * @see [`_z.isRealObject()`](/functions/isRealObject.html) for the most useful object check
 *
