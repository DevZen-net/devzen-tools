 ...
 *
 * @see [`_z.functionType`](/functions/functionType.html) for the underlying function
 *
 * @see [`_z.isUserClass()`](/functions/isUserClass.html) to exclude internal ones like Promise, Object, Array etc
 */
 ...
 *
 * @see [`_z.isClass`](/functions/isClass.html) for the more inclusive one
 *
 * @see [`_z.functionType`](/functions/functionType.html) for the underlying function
 */
