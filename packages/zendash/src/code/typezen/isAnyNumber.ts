 ...
 *
 * @see [`_z.isNumber()`](/functions/isNumber.html) for a less inclusive, more strict check
 *
 * @see [`_z.isStrictNumber()`](/functions/isStrictNumber.html) for the most strict check
 *
 * @param val
 */
